...
double HEAD_S1[HEAD_DOF] = {-0.0614018,0.386526} ;
...
double R_LEG_S1[R_LEG_DOF] = {-0.0889301,-0.0552659,0.082794,-0.0889301,0.3614018,-0.0859461} ;
double R_LEG_S2[R_LEG_DOF] = {-0.032172,-0.0552659,0.082794,-0.0889301,0.3614018,-0.0859461} ;
double R_LEG_S_Roll_ini[R_LEG_DOF] = {-0.032172,-0.0552659,0.082794,-0.0989301,0.3714018,-0.0859461} ;
double R_LEG_S_Roll[R_LEG_DOF] = {-0.032172,-0.0552659,0.082794,-0.0989301,0.3714018,-0.0859461} ;

double R_LEG_Kick_initial[R_LEG_DOF] = {-0.032172,-0.0552659,0.082794,-0.0989301,0.3714018,-0.0859461}  ;
double R_LEG_S_Kick_1[R_LEG_DOF] = {-0.032172,-0.0552659,0.309826,0.4089301,0.0904641,-0.0859461} ;
double R_LEG_S_Kick_2[R_LEG_DOF] = {-0.032172,-0.0552659,-0.360532,-0.0989301,0.3714018,-0.0859461} ;

//,-0.0889301,0.3614018, knee ankel
...
void jointStateCB(const robot_specific_msgs::JointState::ConstPtr& joint_state)
{
    ...
    for (int i=0; i<ROBOT_DOF; i++)
    {
      ...
      //      cout << joint_state->name[i] <<": " << joint_state->position[i] << "    ";
        ...
        if (joint_state->name[i] == "RHipRoll")
        {
            ...
            buffer.data.push_back(joint_state->position[i]);
            msgs.data=joint_state->position[i];
            current_state_.publish(msgs);
            hip_roll=joint_state->position[i];
    ...
    diff = (R_LEG_S_Roll[1] - R_LEG_S_Roll_ini[1])/0.05 ;
    //cout << "diff: " << diff << endl;

    if (diff == 4)
    {
        R_LEG_S_Kick_1[5] = -0.0859461 + 0.46 ;
        R_LEG_S_Kick_2[5] = -0.0859461 + 0.46 ;
    }
    else if (diff == 3)
    {
        R_LEG_S_Kick_1[5] = -0.0859461 + 0.26 ;
        R_LEG_S_Kick_2[5] = -0.0859461 + 0.26 ;
        cout<<"R_LEG_S_Kick_1[5]"<<R_LEG_S_Kick_1[5]<<endl;
    }
    else if (diff == 2)
    {
        cout << "hello world diff2: " << R_LEG_S_Kick_1[5]<<endl;
        R_LEG_S_Kick_1[5] = -0.0859461 - 0.04;
        R_LEG_S_Kick_2[5] = -0.0859461 - 0.04;
    }

    else //if (R_LEG_S_Roll[1] == R_LEG_S_Roll_ini[1])
    {
        cout << "hello world diff else: " << R_LEG_S_Kick_1[5]<<endl;
        R_LEG_S_Kick_1[5] = -0.408992;
        R_LEG_S_Kick_2[5] = -0.408992;
        R_LEG_S_Kick_2[4] = 0.638992;
    }
...
void robotActionCB(const std_msgs::Int16::ConstPtr& msg)
{
    ...
    case 0:
        ...
        sleep(1);
        cout << "R_LEG_S_Kick_1: " << R_LEG_S_Kick_1[0] << ' ' << R_LEG_S_Kick_1[1] << ' ' << R_LEG_S_Kick_1[2] << ' ' << R_LEG_S_Kick_1[3] << ' ' << R_LEG_S_Kick_1[4] << ' ' << R_LEG_S_Kick_1[5] << endl;
        sendTargetJointStateRLeg(R_LEG_S_Kick_2) ;
        cout << "R_LEG_S_Kick_2: " << R_LEG_S_Kick_2[0] << ' ' << R_LEG_S_Kick_2[1] << ' ' << R_LEG_S_Kick_2[2] << ' ' << R_LEG_S_Kick_2[3] << ' ' << R_LEG_S_Kick_2[4] << ' ' << R_LEG_S_Kick_2[5] << endl;
        sleep(2);
        sendTargetJointStateRLeg(R_LEG_S_Roll) ;
        cout << "R_LEG_S_Roll: " << R_LEG_S_Roll[0] << ' ' << R_LEG_S_Roll[1] << ' ' << R_LEG_S_Roll[2] << ' ' << R_LEG_S_Roll[3] << ' ' << R_LEG_S_Roll[4] << ' ' << R_LEG_S_Roll[5] << endl;
...
int main(int argc, char** argv)
{
    ...
    current_state_= central_node_nh.advertise<std_msgs::Float32>("current_hipp_state", 1);
